    ...
    _ ->                                             % If not, attempt to parse
      Result = case ParseFun(Node) of
        ...
        #pegjs_node{} = Match ->                     % If it passes, transform and memoize the result.
          Match;
        Other -> match(Other, Node)                  % for convenience, you can return a match only, not the full node
      end,
...
match(NewMatch, Node)             -> Node#pegjs_node{match = NewMatch}.
...
text(#pegjs_node{text = Text}) -> Text.
...
pegjs_rule('Initializer', Node) -> 
  pegjs( Node
       , 'Initializer'
       , fun(N) -> 
           (pegjs_combinator_action(fun pegjs_custom_fun_146_126/1, pegjs_combinator_sequence([pegjs_combinator_labeled(<<"code">>, pegjs_combinator_rule_ref('CodeBlock')), pegjs_combinator_rule_ref('EOS')])))(N)
         end
       );
pegjs_rule('Rule', Node) -> 
  pegjs( Node
       , 'Rule'
       , fun(N) -> 
           (pegjs_combinator_action(fun pegjs_custom_fun_171_6/1, pegjs_combinator_sequence([pegjs_combinator_labeled(<<"name">>, pegjs_combinator_rule_ref('IdentifierName')), pegjs_combinator_rule_ref('__'), pegjs_combinator_labeled(<<"displayName">>, pegjs_combinator_suffixed('optional', pegjs_combinator_sequence([pegjs_combinator_rule_ref('StringLiteral'), pegjs_combinator_rule_ref('__')]))), pegjs_combinator_literal(<<61>>, false), pegjs_combinator_rule_ref('__'), pegjs_combinator_labeled(<<"expression">>, pegjs_combinator_rule_ref('Expression')), pegjs_combinator_rule_ref('EOS')])))(N)
         end
       );
...
pegjs_rule('ChoiceExpression', Node) -> 
  pegjs( Node
       , 'ChoiceExpression'
       , fun(N) -> 
           (pegjs_combinator_action(fun pegjs_custom_fun_189_6/1, pegjs_combinator_sequence([pegjs_combinator_labeled(<<"first">>, pegjs_combinator_rule_ref('ActionExpression')), pegjs_combinator_labeled(<<"rest">>, pegjs_combinator_suffixed('zero_or_more', pegjs_combinator_sequence([pegjs_combinator_rule_ref('__'), pegjs_combinator_literal(<<47>>, false), pegjs_combinator_rule_ref('__'), pegjs_combinator_rule_ref('ActionExpression')])))])))(N)
         end
       );
...
pegjs_rule('SequenceExpression', Node) -> 
  pegjs( Node
       , 'SequenceExpression'
       , fun(N) -> 
           (pegjs_combinator_action(fun pegjs_custom_fun_220_6/1, pegjs_combinator_sequence([pegjs_combinator_labeled(<<"first">>, pegjs_combinator_rule_ref('LabeledExpression')), pegjs_combinator_labeled(<<"rest">>, pegjs_combinator_suffixed('zero_or_more', pegjs_combinator_sequence([pegjs_combinator_rule_ref('__'), pegjs_combinator_rule_ref('LabeledExpression')])))])))(N)
         end
       );
pegjs_rule('LabeledExpression', Node) -> 
  pegjs( Node
       , 'LabeledExpression'
       , fun(N) -> 
           (pegjs_combinator_choice([pegjs_combinator_action(fun pegjs_custom_fun_231_6/1, pegjs_combinator_sequence([pegjs_combinator_labeled(<<"label">>, pegjs_combinator_rule_ref('Identifier')), pegjs_combinator_rule_ref('__'), pegjs_combinator_literal(<<58>>, false), pegjs_combinator_rule_ref('__'), pegjs_combinator_labeled(<<"expression">>, pegjs_combinator_rule_ref('PrefixedExpression'))])), pegjs_combinator_rule_ref('PrefixedExpression')]))(N)
         end
       );
...
pegjs_rule('SuffixedExpression', Node) -> 
  pegjs( Node
       , 'SuffixedExpression'
       , fun(N) -> 
           (pegjs_combinator_choice([pegjs_combinator_action(fun pegjs_custom_fun_258_6/1, pegjs_combinator_sequence([pegjs_combinator_labeled(<<"expression">>, pegjs_combinator_rule_ref('PrimaryExpression')), pegjs_combinator_rule_ref('__'), pegjs_combinator_labeled(<<"operator">>, pegjs_combinator_rule_ref('SuffixedOperator'))])), pegjs_combinator_rule_ref('PrimaryExpression')]))(N)
         end
       );
...
pegjs_rule('PrimaryExpression', Node) -> 
  pegjs( Node
       , 'PrimaryExpression'
       , fun(N) -> 
           (pegjs_combinator_choice([pegjs_combinator_rule_ref('LiteralMatcher'), pegjs_combinator_rule_ref('CharacterClassMatcher'), pegjs_combinator_rule_ref('AnyMatcher'), pegjs_combinator_rule_ref('RuleReferenceExpression'), pegjs_combinator_rule_ref('SemanticPredicateExpression'), pegjs_combinator_action(fun pegjs_custom_fun_272_74/1, pegjs_combinator_sequence([pegjs_combinator_literal(<<40>>, false), pegjs_combinator_rule_ref('__'), pegjs_combinator_labeled(<<"expression">>, pegjs_combinator_rule_ref('Expression')), pegjs_combinator_rule_ref('__'), pegjs_combinator_literal(<<41>>, false)]))]))(N)
         end
       );
...
pegjs_rule('SemanticPredicateExpression', Node) -> 
  pegjs( Node
       ...
       , fun(N) -> 
           (pegjs_combinator_action(fun pegjs_custom_fun_290_6/1, pegjs_combinator_sequence([pegjs_combinator_labeled(<<"operator">>, pegjs_combinator_rule_ref('SemanticPredicateOperator')), pegjs_combinator_rule_ref('__'), pegjs_combinator_labeled(<<"code">>, pegjs_combinator_rule_ref('CodeBlock'))])))(N)
         end
       );
...
pegjs_rule('Identifier', Node) -> 
  pegjs( Node
       , 'Identifier'
       , fun(N) -> 
           (pegjs_combinator_action(fun pegjs_custom_fun_334_66/1, pegjs_combinator_sequence([pegjs_combinator_prefixed('simple_not', pegjs_combinator_rule_ref('ReservedWord')), pegjs_combinator_labeled(<<"name">>, pegjs_combinator_rule_ref('IdentifierName'))])))(N)
         end
       );
pegjs_rule('IdentifierName', Node) -> 
  pegjs( Node
       , 'IdentifierName'
       , fun(N) -> 
           (pegjs_combinator_named(pegjs_combinator_action(fun pegjs_custom_fun_337_121/1, pegjs_combinator_sequence([pegjs_combinator_labeled(<<"first">>, pegjs_combinator_rule_ref('IdentifierStart')), pegjs_combinator_labeled(<<"rest">>, pegjs_combinator_suffixed('zero_or_more', pegjs_combinator_rule_ref('IdentifierPart')))]))))(N)
         end
       );
pegjs_rule('IdentifierStart', Node) -> 
  pegjs( Node
       , 'IdentifierStart'
       , fun(N) -> 
           (pegjs_combinator_choice([pegjs_combinator_rule_ref('UnicodeLetter'), pegjs_combinator_literal(<<36>>, false), pegjs_combinator_literal(<<95>>, false), pegjs_combinator_action(fun pegjs_custom_fun_343_72/1, pegjs_combinator_sequence([pegjs_combinator_literal(<<92>>, false), pegjs_combinator_labeled(<<"sequence">>, pegjs_combinator_rule_ref('UnicodeEscapeSequence'))]))]))(N)
         end
       );
...
pegjs_rule('LiteralMatcher', Node) -> 
  pegjs( Node
       , 'LiteralMatcher'
       , fun(N) -> 
           (pegjs_combinator_named(pegjs_combinator_action(fun pegjs_custom_fun_428_6/1, pegjs_combinator_sequence([pegjs_combinator_labeled(<<"value">>, pegjs_combinator_rule_ref('StringLiteral')), pegjs_combinator_labeled(<<"ignoreCase">>, pegjs_combinator_suffixed('optional', pegjs_combinator_literal(<<105>>, false)))]))))(N)
         end
       );
pegjs_rule('StringLiteral', Node) -> 
  pegjs( Node
       , 'StringLiteral'
       , fun(N) -> 
           (pegjs_combinator_named(pegjs_combinator_choice([pegjs_combinator_action(fun pegjs_custom_fun_431_88/1, pegjs_combinator_sequence([pegjs_combinator_literal(<<34>>, false), pegjs_combinator_labeled(<<"chars">>, pegjs_combinator_suffixed('zero_or_more', pegjs_combinator_rule_ref('DoubleStringCharacter'))), pegjs_combinator_literal(<<34>>, false)])), pegjs_combinator_action(fun pegjs_custom_fun_432_88/1, pegjs_combinator_sequence([pegjs_combinator_literal(<<39>>, false), pegjs_combinator_labeled(<<"chars">>, pegjs_combinator_suffixed('zero_or_more', pegjs_combinator_rule_ref('SingleStringCharacter'))), pegjs_combinator_literal(<<39>>, false)]))])))(N)
         end
       );
pegjs_rule('DoubleStringCharacter', Node) -> 
  pegjs( Node
       ...
       , fun(N) -> 
           (pegjs_combinator_choice([pegjs_combinator_action(fun pegjs_custom_fun_435_66/1, pegjs_combinator_sequence([pegjs_combinator_prefixed('simple_not', pegjs_combinator_choice([pegjs_combinator_literal(<<34>>, false), pegjs_combinator_literal(<<92>>, false), pegjs_combinator_rule_ref('LineTerminator')])), pegjs_combinator_rule_ref('SourceCharacter')])), pegjs_combinator_action(fun pegjs_custom_fun_436_65/1, pegjs_combinator_sequence([pegjs_combinator_literal(<<92>>, false), pegjs_combinator_labeled(<<"sequence">>, pegjs_combinator_rule_ref('EscapeSequence'))])), pegjs_combinator_rule_ref('LineContinuation')]))(N)
         end
       );
pegjs_rule('SingleStringCharacter', Node) -> 
  pegjs( Node
       ...
       , fun(N) -> 
           (pegjs_combinator_choice([pegjs_combinator_action(fun pegjs_custom_fun_440_66/1, pegjs_combinator_sequence([pegjs_combinator_prefixed('simple_not', pegjs_combinator_choice([pegjs_combinator_literal(<<39>>, false), pegjs_combinator_literal(<<92>>, false), pegjs_combinator_rule_ref('LineTerminator')])), pegjs_combinator_rule_ref('SourceCharacter')])), pegjs_combinator_action(fun pegjs_custom_fun_441_65/1, pegjs_combinator_sequence([pegjs_combinator_literal(<<92>>, false), pegjs_combinator_labeled(<<"sequence">>, pegjs_combinator_rule_ref('EscapeSequence'))])), pegjs_combinator_rule_ref('LineContinuation')]))(N)
         end
       );
...
pegjs_rule('ClassCharacterRange', Node) -> 
  pegjs( Node
       , 'ClassCharacterRange'
       , fun(N) -> 
           (pegjs_combinator_action(fun pegjs_custom_fun_473_6/1, pegjs_combinator_sequence([pegjs_combinator_labeled(<<"begin">>, pegjs_combinator_rule_ref('ClassCharacter')), pegjs_combinator_literal(<<45>>, false), pegjs_combinator_labeled(<<"end">>, pegjs_combinator_rule_ref('ClassCharacter'))])))(N)
         end
       );
pegjs_rule('ClassCharacter', Node) -> 
  pegjs( Node
       , 'ClassCharacter'
       , fun(N) -> 
           (pegjs_combinator_choice([pegjs_combinator_action(fun pegjs_custom_fun_476_66/1, pegjs_combinator_sequence([pegjs_combinator_prefixed('simple_not', pegjs_combinator_choice([pegjs_combinator_literal(<<93>>, false), pegjs_combinator_literal(<<92>>, false), pegjs_combinator_rule_ref('LineTerminator')])), pegjs_combinator_rule_ref('SourceCharacter')])), pegjs_combinator_action(fun pegjs_custom_fun_477_83/1, pegjs_combinator_sequence([pegjs_combinator_literal(<<92>>, false), pegjs_combinator_labeled(<<"sequence">>, pegjs_combinator_rule_ref('EscapeSequence'))])), pegjs_combinator_action(fun pegjs_custom_fun_478_36/1, pegjs_combinator_rule_ref('LineContinuation'))]))(N)
         end
       );
pegjs_rule('LineContinuation', Node) -> 
  pegjs( Node
       , 'LineContinuation'
       , fun(N) -> 
           (pegjs_combinator_action(fun pegjs_custom_fun_481_43/1, pegjs_combinator_sequence([pegjs_combinator_literal(<<92>>, false), pegjs_combinator_rule_ref('LineTerminatorSequence')])))(N)
         end
       );
pegjs_rule('EscapeSequence', Node) -> 
  pegjs( Node
       , 'EscapeSequence'
       , fun(N) -> 
           (pegjs_combinator_choice([pegjs_combinator_rule_ref('CharacterEscapeSequence'), pegjs_combinator_action(fun pegjs_custom_fun_485_35/1, pegjs_combinator_sequence([pegjs_combinator_literal(<<48>>, false), pegjs_combinator_prefixed('simple_not', pegjs_combinator_rule_ref('DecimalDigit'))])), pegjs_combinator_rule_ref('HexEscapeSequence'), pegjs_combinator_rule_ref('UnicodeEscapeSequence')]))(N)
         end
       );
...
pegjs_rule('SingleEscapeCharacter', Node) -> 
  pegjs( Node
       ...
       , fun(N) -> 
           (pegjs_combinator_choice([pegjs_combinator_literal(<<39>>, false), pegjs_combinator_literal(<<34>>, false), pegjs_combinator_literal(<<92>>, false), pegjs_combinator_action(fun pegjs_custom_fun_497_24/1, pegjs_combinator_literal(<<98>>, false)), pegjs_combinator_action(fun pegjs_custom_fun_498_24/1, pegjs_combinator_literal(<<102>>, false)), pegjs_combinator_action(fun pegjs_custom_fun_499_24/1, pegjs_combinator_literal(<<110>>, false)), pegjs_combinator_action(fun pegjs_custom_fun_500_24/1, pegjs_combinator_literal(<<114>>, false)), pegjs_combinator_action(fun pegjs_custom_fun_501_24/1, pegjs_combinator_literal(<<116>>, false)), pegjs_combinator_action(fun pegjs_custom_fun_502_24/1, pegjs_combinator_literal(<<118>>, false))]))(N)
         end
       );
pegjs_rule('NonEscapeCharacter', Node) -> 
  pegjs( Node
       , 'NonEscapeCharacter'
       , fun(N) -> 
           (pegjs_combinator_action(fun pegjs_custom_fun_505_71/1, pegjs_combinator_sequence([pegjs_combinator_prefixed('simple_not', pegjs_combinator_choice([pegjs_combinator_rule_ref('EscapeCharacter'), pegjs_combinator_rule_ref('LineTerminator')])), pegjs_combinator_rule_ref('SourceCharacter')])))(N)
         end
       );
...
pegjs_rule('HexEscapeSequence', Node) -> 
  pegjs( Node
       , 'HexEscapeSequence'
       , fun(N) -> 
           (pegjs_combinator_action(fun pegjs_custom_fun_516_6/1, pegjs_combinator_sequence([pegjs_combinator_literal(<<120>>, false), pegjs_combinator_labeled(<<"digits">>, pegjs_combinator_text(pegjs_combinator_sequence([pegjs_combinator_rule_ref('HexDigit'), pegjs_combinator_rule_ref('HexDigit')])))])))(N)
         end
       );
...
pegjs_rule('AnyMatcher', Node) -> 
  pegjs( Node
       , 'AnyMatcher'
       , fun(N) -> 
           (pegjs_combinator_action(fun pegjs_custom_fun_530_37/1, pegjs_combinator_literal(<<46>>, false)))(N)
         end
       );
pegjs_rule('CodeBlock', Node) -> 
  pegjs( Node
       , 'CodeBlock'
       , fun(N) -> 
           (pegjs_combinator_named(pegjs_combinator_action(fun pegjs_custom_fun_533_50/1, pegjs_combinator_sequence([pegjs_combinator_literal(<<123>>, false), pegjs_combinator_labeled(<<"code">>, pegjs_combinator_rule_ref('Code')), pegjs_combinator_literal(<<125>>, false)]))))(N)
         end
       );
...
pegjs_combinator_all([], Node0, Accum, Text) ->
  Result = lists:reverse(Accum),
  Node0#pegjs_node{match = Result, text = Text};
pegjs_combinator_all([P|Parsers], Node0, Accum, Text0) ->
  case P(Node0) of
    {error, _} = Failure -> Failure;
    Node ->
      pegjs_combinator_all(Parsers, Node, [match(Node)|Accum], <<Text0/binary, (text(Node))/binary>>)
  end.
...
pegjs_combinator_prefixed(semantic_and, CustomFun) ->
  fun(Node0) ->
    case CustomFun(Node0) of
      ...
      true                 -> Node0#pegjs_node{match = [], text = <<>>};
      Node                 -> Node#pegjs_node{match = [], text = <<>>}
    end
  end;
...
pegjs_combinator_prefixed(semantic_not, CustomFun) ->
  fun(Node0) ->
    case CustomFun(Node0) of
      {error, _}    -> Node0#pegjs_node{match = [], text = <<>>};
      false         -> Node0#pegjs_node{match = [], text = <<>>};
...
pegjs_combinator_scan(_, #pegjs_node{input = []} = Node, Accum, Text) ->
  Node#pegjs_node{match = lists:reverse(Accum), text = Text};
pegjs_combinator_scan(P, Node0, Accum, Text0) ->
  case P(Node0) of
    {error,_N} -> Node0#pegjs_node{match = lists:reverse(Accum)};
    Node       ->
      pegjs_combinator_scan(P, Node, [match(Node) | Accum], <<Text0/binary, (text(Node))/binary>>)
  end.
    ...
    case P(Node0) of
      ...
      Node           ->
        case CustomFun(Node) of
          ...
          {error, _} = E        -> E;
          Other                 -> Node#pegjs_node{match = Other}
        end
    end
  end.
...
pegjs_combinator_text(P) ->
  fun(Node0) ->
      ...
      case Result of
        {error, _} = E -> E;
        Node           ->
          IoList = pegjs_util_convert_to_iolist(match(Node)),
          Node#pegjs_node{match = iolist_to_binary(IoList)}
      end
  end.

-spec pegjs_custom_fun_505_71(#pegjs_node{}) -> #pegjs_node{} | {error, term()}.
pegjs_custom_fun_505_71(Node) -> 
 text(Node) .

-spec pegjs_custom_fun_485_35(#pegjs_node{}) -> #pegjs_node{} | {error, term()}.
pegjs_custom_fun_485_35(_Node) -> 
 <<"\0">> .

-spec pegjs_custom_fun_468_6(#pegjs_node{}) -> #pegjs_node{} | {error, term()}.
pegjs_custom_fun_468_6(Node) -> 
...
-spec pegjs_custom_fun_205_6(#pegjs_node{}) -> #pegjs_node{} | {error, term()}.
pegjs_custom_fun_205_6(Node) -> 
...
-spec pegjs_custom_fun_189_6(#pegjs_node{}) -> #pegjs_node{} | {error, term()}.
pegjs_custom_fun_189_6(Node) -> 
...
-spec pegjs_custom_fun_516_6(#pegjs_node{}) -> #pegjs_node{} | {error, term()}.
pegjs_custom_fun_516_6(Node) -> 

      hexstr_to_bin(value(<<"digits">>, Node))
    .

-spec pegjs_custom_fun_436_65(#pegjs_node{}) -> #pegjs_node{} | {error, term()}.
pegjs_custom_fun_436_65(Node) -> 
 value(<<"sequence">>, Node) .

-spec pegjs_custom_fun_343_72(#pegjs_node{}) -> #pegjs_node{} | {error, term()}.
pegjs_custom_fun_343_72(Node) -> 
 value(<<"sequence">>, Node) .

-spec pegjs_custom_fun_432_88(#pegjs_node{}) -> #pegjs_node{} | {error, term()}.
pegjs_custom_fun_432_88(Node) -> 
 iolist_to_binary(value(<<"chars">>, Node)) .

-spec pegjs_custom_fun_143_6(#pegjs_node{}) -> #pegjs_node{} | {error, term()}.
pegjs_custom_fun_143_6(Node) -> 
...
-spec pegjs_custom_fun_498_24(#pegjs_node{}) -> #pegjs_node{} | {error, term()}.
pegjs_custom_fun_498_24(_Node) -> 
 <<"\f">>   .

-spec pegjs_custom_fun_481_43(#pegjs_node{}) -> #pegjs_node{} | {error, term()}.
pegjs_custom_fun_481_43(_Node) -> 
 <<"">> .

-spec pegjs_custom_fun_478_36(#pegjs_node{}) -> #pegjs_node{} | {error, term()}.
pegjs_custom_fun_478_36(Node) -> 
 text(Node) .

-spec pegjs_custom_fun_280_6(#pegjs_node{}) -> #pegjs_node{} | {error, term()}.
pegjs_custom_fun_280_6(Node) -> 
...
-spec pegjs_custom_fun_146_126(#pegjs_node{}) -> #pegjs_node{} | {error, term()}.
pegjs_custom_fun_146_126(Node) -> 
 Code = value(<<"code">>, Node), #entry{type = <<"initializer">>, code = Code, index = index(Node)} .

-spec pegjs_custom_fun_500_24(#pegjs_node{}) -> #pegjs_node{} | {error, term()}.
pegjs_custom_fun_500_24(_Node) -> 
 <<"\r">>   .

-spec pegjs_custom_fun_220_6(#pegjs_node{}) -> #pegjs_node{} | {error, term()}.
pegjs_custom_fun_220_6(Node) -> 
...
-spec pegjs_custom_fun_502_24(#pegjs_node{}) -> #pegjs_node{} | {error, term()}.
pegjs_custom_fun_502_24(_Node) -> 
 <<"\v">>   .

-spec pegjs_custom_fun_477_83(#pegjs_node{}) -> #pegjs_node{} | {error, term()}.
pegjs_custom_fun_477_83(Node) -> 
 iolist_to_binary(value(<<"sequence">>, Node)) .

-spec pegjs_custom_fun_440_66(#pegjs_node{}) -> #pegjs_node{} | {error, term()}.
pegjs_custom_fun_440_66(Node) -> 
 text(Node) .

-spec pegjs_custom_fun_428_6(#pegjs_node{}) -> #pegjs_node{} | {error, term()}.
pegjs_custom_fun_428_6(Node) -> 
...
-spec pegjs_custom_fun_272_74(#pegjs_node{}) -> #pegjs_node{} | {error, term()}.
pegjs_custom_fun_272_74(Node) -> 
 value(<<"expression">>, Node) .

-spec pegjs_custom_fun_431_88(#pegjs_node{}) -> #pegjs_node{} | {error, term()}.
pegjs_custom_fun_431_88(Node) -> 
 iolist_to_binary(value(<<"chars">>, Node)) .

-spec pegjs_custom_fun_231_6(#pegjs_node{}) -> #pegjs_node{} | {error, term()}.
pegjs_custom_fun_231_6(Node) -> 
...
-spec pegjs_custom_fun_497_24(#pegjs_node{}) -> #pegjs_node{} | {error, term()}.
pegjs_custom_fun_497_24(_Node) -> 
 <<"\b">>   .

-spec pegjs_custom_fun_435_66(#pegjs_node{}) -> #pegjs_node{} | {error, term()}.
pegjs_custom_fun_435_66(Node) -> 
 text(Node) .

-spec pegjs_custom_fun_530_37(#pegjs_node{}) -> #pegjs_node{} | {error, term()}.
pegjs_custom_fun_530_37(_Node) -> 
 #entry{type = <<"any">>} .

-spec pegjs_custom_fun_476_66(#pegjs_node{}) -> #pegjs_node{} | {error, term()}.
pegjs_custom_fun_476_66(Node) -> 
 text(Node) .

-spec pegjs_custom_fun_499_24(#pegjs_node{}) -> #pegjs_node{} | {error, term()}.
pegjs_custom_fun_499_24(_Node) -> 
 <<"\n">>   .

-spec pegjs_custom_fun_473_6(#pegjs_node{}) -> #pegjs_node{} | {error, term()}.
pegjs_custom_fun_473_6(Node) -> 

      [value(<<"begin">>, Node), value(<<"end">>, Node)]
    .

-spec pegjs_custom_fun_242_6(#pegjs_node{}) -> #pegjs_node{} | {error, term()}.
pegjs_custom_fun_242_6(Node) -> 
...
-spec pegjs_custom_fun_533_50(#pegjs_node{}) -> #pegjs_node{} | {error, term()}.
pegjs_custom_fun_533_50(Node) -> 
 value(<<"code">>, Node) .

-spec pegjs_custom_fun_521_6(#pegjs_node{}) -> #pegjs_node{} | {error, term()}.
pegjs_custom_fun_521_6(Node) -> 

      hexstr_to_bin(value(<<"digits">>, Node))
    .

-spec pegjs_custom_fun_441_65(#pegjs_node{}) -> #pegjs_node{} | {error, term()}.
pegjs_custom_fun_441_65(Node) -> 
 value(<<"sequence">>, Node) .

-spec pegjs_custom_fun_337_121(#pegjs_node{}) -> #pegjs_node{} | {error, term()}.
pegjs_custom_fun_337_121(Node) -> 
 iolist_to_binary([value(<<"first">>, Node), value(<<"rest">>, Node)]) .

-spec pegjs_custom_fun_334_66(#pegjs_node{}) -> #pegjs_node{} | {error, term()}.
pegjs_custom_fun_334_66(Node) -> 
 value(<<"name">>, Node) .

-spec pegjs_custom_fun_290_6(#pegjs_node{}) -> #pegjs_node{} | {error, term()}.
pegjs_custom_fun_290_6(Node) -> 
...
-spec pegjs_custom_fun_258_6(#pegjs_node{}) -> #pegjs_node{} | {error, term()}.
pegjs_custom_fun_258_6(Node) -> 
...
-spec pegjs_custom_fun_171_6(#pegjs_node{}) -> #pegjs_node{} | {error, term()}.
pegjs_custom_fun_171_6(Node) -> 
...
-spec pegjs_custom_fun_501_24(#pegjs_node{}) -> #pegjs_node{} | {error, term()}.
pegjs_custom_fun_501_24(_Node) -> 
 <<"\t">>   .
