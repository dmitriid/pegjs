...
pegjs_rule(<<"grammar">>, Input, Index) -> 
  pegjs( Input
       ...
       , <<"grammar">>
       , fun(I, D) ->
           (pegjs_combinator('sequence', [pegjs_combinator('labeled', {undefined, [pegjs_combinator('rule_ref', <<"__">>, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end), pegjs_combinator('labeled', {<<"initializer">>, [pegjs_combinator('suffixed', {optional, [pegjs_combinator('rule_ref', <<"initializer">>, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end), pegjs_combinator('labeled', {<<"rules">>, [pegjs_combinator('suffixed', {one_or_more, [pegjs_combinator('rule_ref', <<"rule">>, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end)], fun pegjs_code_102_1/2))(I, D)
         end
...
pegjs_rule(<<"initializer">>, Input, Index) -> 
  pegjs( Input
       ...
       , <<"initializer">>
       , fun(I, D) ->
           (pegjs_combinator('sequence', [pegjs_combinator('labeled', {<<"code">>, [pegjs_combinator('rule_ref', <<"action">>, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end), pegjs_combinator('labeled', {undefined, [pegjs_combinator('suffixed', {optional, [pegjs_combinator('rule_ref', <<"semicolon">>, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end)], fun pegjs_code_109_1/2))(I, D)
         end
       , fun(Node, _Idx) -> Node end
       );
pegjs_rule(<<"rule">>, Input, Index) -> 
  pegjs( Input
       ...
       , <<"rule">>
       , fun(I, D) ->
           (pegjs_combinator('sequence', [pegjs_combinator('labeled', {<<"name">>, [pegjs_combinator('rule_ref', <<"identifier">>, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end), pegjs_combinator('labeled', {<<"displayName">>, [pegjs_combinator('suffixed', {optional, [pegjs_combinator('rule_ref', <<"string">>, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end), pegjs_combinator('labeled', {undefined, [pegjs_combinator('rule_ref', <<"equals">>, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end), pegjs_combinator('labeled', {<<"expression">>, [pegjs_combinator('rule_ref', <<"expression">>, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end), pegjs_combinator('labeled', {undefined, [pegjs_combinator('suffixed', {optional, [pegjs_combinator('rule_ref', <<"semicolon">>, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end)], fun pegjs_code_120_1/2))(I, D)
         end
       , fun(Node, _Idx) -> Node end
       );
...
pegjs_rule(<<"choice">>, Input, Index) -> 
  pegjs( Input
       ...
       , <<"choice">>
       , fun(I, D) ->
           (pegjs_combinator('sequence', [pegjs_combinator('labeled', {<<"head">>, [pegjs_combinator('rule_ref', <<"sequence">>, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end), pegjs_combinator('labeled', {<<"tail">>, [pegjs_combinator('suffixed', {zero_or_more, [pegjs_combinator('sequence', [pegjs_combinator('labeled', {undefined, [pegjs_combinator('rule_ref', <<"slash">>, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end), pegjs_combinator('labeled', {undefined, [pegjs_combinator('rule_ref', <<"sequence">>, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end)], fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end)], fun pegjs_code_139_1/2))(I, D)
         end
       , fun(Node, _Idx) -> Node end
       );
pegjs_rule(<<"sequence">>, Input, Index) -> 
  pegjs( Input
       ...
       , <<"sequence">>
       , fun(I, D) ->
           (pegjs_combinator('choice', [pegjs_combinator('sequence', [pegjs_combinator('labeled', {<<"elements">>, [pegjs_combinator('suffixed', {zero_or_more, [pegjs_combinator('rule_ref', <<"labeled">>, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end), pegjs_combinator('labeled', {<<"code">>, [pegjs_combinator('rule_ref', <<"action">>, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end)], fun pegjs_code_155_3/2), pegjs_combinator('sequence', [pegjs_combinator('labeled', {<<"elements">>, [pegjs_combinator('suffixed', {zero_or_more, [pegjs_combinator('rule_ref', <<"labeled">>, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end)], fun pegjs_code_168_1/2)], fun(Node, _) -> Node end))(I, D)
         end
       , fun(Node, _Idx) -> Node end
       );
...
pegjs_rule(<<"prefixed">>, Input, Index) -> 
  pegjs( Input
       ...
       , <<"prefixed">>
       , fun(I, D) ->
           (pegjs_combinator('choice', [pegjs_combinator('sequence', [pegjs_combinator('labeled', {<<"dollar">>, [pegjs_combinator('rule_ref', <<"dollar">>, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end), pegjs_combinator('labeled', {<<"expression">>, [pegjs_combinator('rule_ref', <<"suffixed">>, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end)], fun pegjs_code_192_3/2), pegjs_combinator('sequence', [pegjs_combinator('labeled', {<<"and">>, [pegjs_combinator('rule_ref', <<"and">>, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end), pegjs_combinator('labeled', {<<"code">>, [pegjs_combinator('rule_ref', <<"action">>, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end)], fun pegjs_code_202_3/2), pegjs_combinator('sequence', [pegjs_combinator('labeled', {<<"and">>, [pegjs_combinator('rule_ref', <<"and">>, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end), pegjs_combinator('labeled', {<<"expression">>, [pegjs_combinator('rule_ref', <<"suffixed">>, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end)], fun pegjs_code_210_3/2), pegjs_combinator('sequence', [pegjs_combinator('labeled', {<<"not">>, [pegjs_combinator('rule_ref', <<"not">>, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end), pegjs_combinator('labeled', {<<"code">>, [pegjs_combinator('rule_ref', <<"action">>, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end)], fun pegjs_code_220_3/2), pegjs_combinator('sequence', [pegjs_combinator('labeled', {<<"not">>, [pegjs_combinator('rule_ref', <<"not">>, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end), pegjs_combinator('labeled', {<<"expression">>, [pegjs_combinator('rule_ref', <<"suffixed">>, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end)], fun pegjs_code_228_3/2), pegjs_combinator('sequence', [pegjs_combinator('labeled', {undefined, [pegjs_combinator('rule_ref', <<"suffixed">>, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end)], fun(Node, _) -> Node end)], fun(Node, _) -> Node end))(I, D)
         end
       , fun(Node, _Idx) -> Node end
       );
pegjs_rule(<<"suffixed">>, Input, Index) -> 
  pegjs( Input
       ...
       , <<"suffixed">>
       , fun(I, D) ->
           (pegjs_combinator('choice', [pegjs_combinator('sequence', [pegjs_combinator('labeled', {<<"expression">>, [pegjs_combinator('rule_ref', <<"primary">>, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end), pegjs_combinator('labeled', {<<"suffix">>, [pegjs_combinator('rule_ref', <<"question">>, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end)], fun pegjs_code_239_3/2), pegjs_combinator('sequence', [pegjs_combinator('labeled', {<<"expression">>, [pegjs_combinator('rule_ref', <<"primary">>, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end), pegjs_combinator('labeled', {<<"suffix">>, [pegjs_combinator('rule_ref', <<"star">>, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end)], fun pegjs_code_247_3/2), pegjs_combinator('sequence', [pegjs_combinator('labeled', {<<"expression">>, [pegjs_combinator('rule_ref', <<"primary">>, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end), pegjs_combinator('labeled', {<<"suffix">>, [pegjs_combinator('rule_ref', <<"plus">>, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end)], fun pegjs_code_255_3/2), pegjs_combinator('sequence', [pegjs_combinator('labeled', {undefined, [pegjs_combinator('rule_ref', <<"primary">>, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end)], fun(Node, _) -> Node end)], fun(Node, _) -> Node end))(I, D)
         end
       , fun(Node, _Idx) -> Node end
       );
pegjs_rule(<<"primary">>, Input, Index) -> 
  pegjs( Input
       ...
       , <<"primary">>
       , fun(I, D) ->
           (pegjs_combinator('choice', [pegjs_combinator('sequence', [pegjs_combinator('labeled', {<<"name">>, [pegjs_combinator('rule_ref', <<"identifier">>, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end), pegjs_combinator('labeled', {undefined, [pegjs_combinator('prefixed', {simple_not, [pegjs_combinator('sequence', [pegjs_combinator('labeled', {undefined, [pegjs_combinator('suffixed', {optional, [pegjs_combinator('rule_ref', <<"string">>, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end), pegjs_combinator('labeled', {undefined, [pegjs_combinator('rule_ref', <<"equals">>, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end)], fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end)], fun pegjs_code_265_3/2), pegjs_combinator('sequence', [pegjs_combinator('labeled', {undefined, [pegjs_combinator('rule_ref', <<"literal">>, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end)], fun(Node, _) -> Node end), pegjs_combinator('sequence', [pegjs_combinator('labeled', {undefined, [pegjs_combinator('rule_ref', <<"class">>, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end)], fun(Node, _) -> Node end), pegjs_combinator('sequence', [pegjs_combinator('labeled', {undefined, [pegjs_combinator('rule_ref', <<"dot">>, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end)], fun pegjs_code_271_3/2), pegjs_combinator('sequence', [pegjs_combinator('labeled', {undefined, [pegjs_combinator('rule_ref', <<"lparen">>, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end), pegjs_combinator('labeled', {<<"expression">>, [pegjs_combinator('rule_ref', <<"expression">>, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end), pegjs_combinator('labeled', {undefined, [pegjs_combinator('rule_ref', <<"rparen">>, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end)], fun pegjs_code_279_1/2)], fun(Node, _) -> Node end))(I, D)
         end
       , fun(Node, _Idx) -> Node end
       );
pegjs_rule(<<"action">>, Input, Index) -> 
  pegjs( Input
       ...
       , <<"action">>
       , fun(I, D) ->
           (pegjs_combinator('sequence', [pegjs_combinator('labeled', {<<"braced">>, [pegjs_combinator('rule_ref', <<"braced">>, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end), pegjs_combinator('labeled', {undefined, [pegjs_combinator('rule_ref', <<"__">>, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end)], fun pegjs_code_286_1/2))(I, D)
         end
       , fun(Node, _Idx) -> Node end
       );
...
pegjs_rule(<<"lparen">>, Input, Index) -> 
  pegjs( Input
       ...
       , <<"lparen">>
       , fun(I, D) ->
           (pegjs_combinator('sequence', [pegjs_combinator('labeled', {undefined, [pegjs_combinator('literal', {[unicode:characters_to_binary("(")], false}, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end), pegjs_combinator('labeled', {undefined, [pegjs_combinator('rule_ref', <<"__">>, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end)], fun pegjs_code_310_1/2))(I, D)
         end
       , fun(Node, _Idx) -> Node end
       );
pegjs_rule(<<"rparen">>, Input, Index) -> 
  pegjs( Input
       ...
       , <<"rparen">>
       , fun(I, D) ->
           (pegjs_combinator('sequence', [pegjs_combinator('labeled', {undefined, [pegjs_combinator('literal', {[unicode:characters_to_binary(")")], false}, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end), pegjs_combinator('labeled', {undefined, [pegjs_combinator('rule_ref', <<"__">>, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end)], fun pegjs_code_311_1/2))(I, D)
         end
       , fun(Node, _Idx) -> Node end
       );
pegjs_rule(<<"dot">>, Input, Index) -> 
  pegjs( Input
       ...
       , <<"dot">>
       , fun(I, D) ->
           (pegjs_combinator('sequence', [pegjs_combinator('labeled', {undefined, [pegjs_combinator('literal', {[unicode:characters_to_binary(".")], false}, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end), pegjs_combinator('labeled', {undefined, [pegjs_combinator('rule_ref', <<"__">>, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end)], fun pegjs_code_332_1/2))(I, D)
         end
       , fun(Node, _Idx) -> Node end
       );
...
pegjs_rule(<<"string">>, Input, Index) -> 
  pegjs( Input
       ...
       , <<"string">>
       , fun(I, D) ->
           (pegjs_combinator('sequence', [pegjs_combinator('labeled', {<<"string">>, [pegjs_combinator('choice', [pegjs_combinator('sequence', [pegjs_combinator('labeled', {undefined, [pegjs_combinator('rule_ref', <<"doubleQuotedString">>, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end)], fun(Node, _) -> Node end), pegjs_combinator('sequence', [pegjs_combinator('labeled', {undefined, [pegjs_combinator('rule_ref', <<"singleQuotedString">>, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end)], fun(Node, _) -> Node end)], fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end), pegjs_combinator('labeled', {undefined, [pegjs_combinator('rule_ref', <<"__">>, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end)], fun pegjs_code_357_4/2))(I, D)
         end
       , fun(Node, _Idx) -> Node end
       );
...
pegjs_rule(<<"simpleDoubleQuotedCharacter">>, Input, Index) -> 
  pegjs( Input
       ...
       , fun(I, D) ->
           (pegjs_combinator('sequence', [pegjs_combinator('labeled', {undefined, [pegjs_combinator('prefixed', {simple_not, [pegjs_combinator('choice', [pegjs_combinator('sequence', [pegjs_combinator('labeled', {undefined, [pegjs_combinator('literal', {[unicode:characters_to_binary("\"")], false}, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end)], fun(Node, _) -> Node end), pegjs_combinator('sequence', [pegjs_combinator('labeled', {undefined, [pegjs_combinator('literal', {[unicode:characters_to_binary("\\")], false}, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end)], fun(Node, _) -> Node end), pegjs_combinator('sequence', [pegjs_combinator('labeled', {undefined, [pegjs_combinator('rule_ref', <<"eolChar">>, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end)], fun(Node, _) -> Node end)], fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end), pegjs_combinator('labeled', {<<"char_">>, [pegjs_combinator('anything', [], fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end)], fun pegjs_code_381_1/2))(I, D)
         end
       , fun(Node, _Idx) -> Node end
       );
...
pegjs_rule(<<"simpleSingleQuotedCharacter">>, Input, Index) -> 
  pegjs( Input
       ...
       , fun(I, D) ->
           (pegjs_combinator('sequence', [pegjs_combinator('labeled', {undefined, [pegjs_combinator('prefixed', {simple_not, [pegjs_combinator('choice', [pegjs_combinator('sequence', [pegjs_combinator('labeled', {undefined, [pegjs_combinator('literal', {[unicode:characters_to_binary("'")], false}, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end)], fun(Node, _) -> Node end), pegjs_combinator('sequence', [pegjs_combinator('labeled', {undefined, [pegjs_combinator('literal', {[unicode:characters_to_binary("\\")], false}, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end)], fun(Node, _) -> Node end), pegjs_combinator('sequence', [pegjs_combinator('labeled', {undefined, [pegjs_combinator('rule_ref', <<"eolChar">>, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end)], fun(Node, _) -> Node end)], fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end), pegjs_combinator('labeled', {<<"char_">>, [pegjs_combinator('anything', [], fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end)], fun pegjs_code_403_1/2))(I, D)
         end
       , fun(Node, _Idx) -> Node end
       );
...
pegjs_rule(<<"classCharacter">>, Input, Index) -> 
  pegjs( Input
       ...
       , <<"classCharacter">>
       , fun(I, D) ->
           (pegjs_combinator('sequence', [pegjs_combinator('labeled', {undefined, [pegjs_combinator('rule_ref', <<"bracketDelimitedCharacter">>, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end)], fun pegjs_code_454_1/2))(I, D)
         end
       , fun(Node, _Idx) -> Node end
       );
...
pegjs_rule(<<"simpleBracketDelimitedCharacter">>, Input, Index) -> 
  pegjs( Input
       ...
       , fun(I, D) ->
           (pegjs_combinator('sequence', [pegjs_combinator('labeled', {undefined, [pegjs_combinator('prefixed', {simple_not, [pegjs_combinator('choice', [pegjs_combinator('sequence', [pegjs_combinator('labeled', {undefined, [pegjs_combinator('literal', {[unicode:characters_to_binary("]")], false}, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end)], fun(Node, _) -> Node end), pegjs_combinator('sequence', [pegjs_combinator('labeled', {undefined, [pegjs_combinator('literal', {[unicode:characters_to_binary("\\")], false}, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end)], fun(Node, _) -> Node end), pegjs_combinator('sequence', [pegjs_combinator('labeled', {undefined, [pegjs_combinator('rule_ref', <<"eolChar">>, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end)], fun(Node, _) -> Node end)], fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end), pegjs_combinator('labeled', {<<"char_">>, [pegjs_combinator('anything', [], fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end)], fun pegjs_code_469_1/2))(I, D)
         end
       , fun(Node, _Idx) -> Node end
       );
...
pegjs_rule(<<"zeroEscapeSequence">>, Input, Index) -> 
  pegjs( Input
       ...
       , <<"zeroEscapeSequence">>
       , fun(I, D) ->
           (pegjs_combinator('sequence', [pegjs_combinator('labeled', {undefined, [pegjs_combinator('literal', {[unicode:characters_to_binary("\\0")], false}, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end), pegjs_combinator('labeled', {undefined, [pegjs_combinator('prefixed', {simple_not, [pegjs_combinator('rule_ref', <<"digit">>, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end)], fun pegjs_code_490_1/2))(I, D)
         end
       , fun(Node, _Idx) -> Node end
       );
pegjs_rule(<<"hexEscapeSequence">>, Input, Index) -> 
  pegjs( Input
       ...
       , <<"hexEscapeSequence">>
       , fun(I, D) ->
           (pegjs_combinator('sequence', [pegjs_combinator('labeled', {undefined, [pegjs_combinator('literal', {[unicode:characters_to_binary("\\x")], false}, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end), pegjs_combinator('labeled', {<<"digits">>, [pegjs_combinator('sequence', [pegjs_combinator('labeled', {undefined, [pegjs_combinator('rule_ref', <<"hexDigit">>, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end), pegjs_combinator('labeled', {undefined, [pegjs_combinator('rule_ref', <<"hexDigit">>, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end)], fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end)], fun pegjs_code_499_1/2))(I, D)
         end
       , fun(Node, _Idx) -> Node end
       );
pegjs_rule(<<"unicodeEscapeSequence">>, Input, Index) -> 
  pegjs( Input
       ...
       , fun(I, D) ->
           (pegjs_combinator('sequence', [pegjs_combinator('labeled', {undefined, [pegjs_combinator('literal', {[unicode:characters_to_binary("\\u")], false}, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end), pegjs_combinator('labeled', {<<"digits">>, [pegjs_combinator('sequence', [pegjs_combinator('labeled', {undefined, [pegjs_combinator('rule_ref', <<"hexDigit">>, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end), pegjs_combinator('labeled', {undefined, [pegjs_combinator('rule_ref', <<"hexDigit">>, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end), pegjs_combinator('labeled', {undefined, [pegjs_combinator('rule_ref', <<"hexDigit">>, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end), pegjs_combinator('labeled', {undefined, [pegjs_combinator('rule_ref', <<"hexDigit">>, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end)], fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end)], fun pegjs_code_508_1/2))(I, D)
         end
       , fun(Node, _Idx) -> Node end
       );
pegjs_rule(<<"eolEscapeSequence">>, Input, Index) -> 
  pegjs( Input
       ...
       , <<"eolEscapeSequence">>
       , fun(I, D) ->
           (pegjs_combinator('sequence', [pegjs_combinator('labeled', {undefined, [pegjs_combinator('literal', {[unicode:characters_to_binary("\\")], false}, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end), pegjs_combinator('labeled', {<<"eol">>, [pegjs_combinator('rule_ref', <<"eol">>, fun(Node, _) -> Node end)]}, fun(Node, _) -> Node end)], fun pegjs_code_513_4/2))(I, D)
         end
       , fun(Node, _Idx) -> Node end
       );
...
-spec pegjs_code_102_1(iolist(), index()) -> parse_result().
pegjs_code_102_1(Node, Idx) ->
...
-spec pegjs_code_109_1(iolist(), index()) -> parse_result().
pegjs_code_109_1(Node, _Idx) ->

    [{_, Code}, _] = Node,
    Code
  .

-spec pegjs_code_120_1(iolist(), index()) -> parse_result().
pegjs_code_120_1(Node, Idx) ->
...
-spec pegjs_code_139_1(iolist(), index()) -> parse_result().
pegjs_code_139_1(Node, Idx) ->
...
-spec pegjs_code_155_3(iolist(), index()) -> parse_result().
pegjs_code_155_3(Node, Idx) ->
...
-spec pegjs_code_168_1(iolist(), index()) -> parse_result().
pegjs_code_168_1(Node, Idx) ->
...
-spec pegjs_code_177_3(iolist(), index()) -> parse_result().
pegjs_code_177_3(Node, Idx) ->
...
-spec pegjs_code_184_1(iolist(), index()) -> parse_result().
pegjs_code_184_1(Node, Idx) ->
...
-spec pegjs_code_192_3(iolist(), index()) -> parse_result().
pegjs_code_192_3(Node, Idx) ->
...
-spec pegjs_code_202_3(iolist(), index()) -> parse_result().
pegjs_code_202_3(Node, Idx) ->
...
-spec pegjs_code_210_3(iolist(), index()) -> parse_result().
pegjs_code_210_3(Node, Idx) ->
...
-spec pegjs_code_220_3(iolist(), index()) -> parse_result().
pegjs_code_220_3(Node, Idx) ->
...
-spec pegjs_code_228_3(iolist(), index()) -> parse_result().
pegjs_code_228_3(Node, Idx) ->
...
-spec pegjs_code_239_3(iolist(), index()) -> parse_result().
pegjs_code_239_3(Node, Idx) ->
...
-spec pegjs_code_247_3(iolist(), index()) -> parse_result().
pegjs_code_247_3(Node, Idx) ->
...
-spec pegjs_code_255_3(iolist(), index()) -> parse_result().
pegjs_code_255_3(Node, Idx) ->
...
-spec pegjs_code_265_3(iolist(), index()) -> parse_result().
pegjs_code_265_3(Node, Idx) ->
...
-spec pegjs_code_271_3(iolist(), index()) -> parse_result().
pegjs_code_271_3(_Node, Idx) ->

      #anything{ index = Idx }
    .

-spec pegjs_code_279_1(iolist(), index()) -> parse_result().
pegjs_code_279_1(Node, _Idx) ->

      [_, {_, Expression}, _] = Node,
      Expression
    .

-spec pegjs_code_286_1(iolist(), index()) -> parse_result().
pegjs_code_286_1(Node, _Idx) ->

    [{_, Braced}, _] = Node,
    binary:part(Braced, 1, size(Braced) - 2)
  .

-spec pegjs_code_293_1(iolist(), index()) -> parse_result().
pegjs_code_293_1(Node, _Idx) ->
...
-spec pegjs_code_310_1(iolist(), index()) -> parse_result().
pegjs_code_310_1(_Node, _Idx) ->
 <<"(">> .

-spec pegjs_code_311_1(iolist(), index()) -> parse_result().
pegjs_code_311_1(_Node, _Idx) ->
 <<")">> .

-spec pegjs_code_332_1(iolist(), index()) -> parse_result().
pegjs_code_332_1(_Node, _Idx) ->
 <<".">> .

-spec pegjs_code_343_1(iolist(), index()) -> parse_result().
pegjs_code_343_1(Node, _Idx) ->

    [{_, Chars}, _] = Node,
    iolist_to_binary(do_convert_to_iolist(Chars))
  .

-spec pegjs_code_352_1(iolist(), index()) -> parse_result().
pegjs_code_352_1(Node, _Idx) ->
...
-spec pegjs_code_357_4(iolist(), index()) -> parse_result().
pegjs_code_357_4(Node, _Idx) ->

    [{_, String}, _] = Node,
    String
  .

-spec pegjs_code_366_1(iolist(), index()) -> parse_result().
pegjs_code_366_1(Node, _Idx) ->

    [_, {_, Chars}, _] = Node,
    Chars
  .

-spec pegjs_code_381_1(iolist(), index()) -> parse_result().
pegjs_code_381_1(Node, _Idx) ->

    [_, {_, Char_}] = Node,
    Char_
  .

-spec pegjs_code_388_1(iolist(), index()) -> parse_result().
pegjs_code_388_1(Node, _Idx) ->

    [_, {_, Chars}, _] = Node,
    Chars
  .

-spec pegjs_code_403_1(iolist(), index()) -> parse_result().
pegjs_code_403_1(Node, _Idx) ->

    [_, {_, Char_}] = Node,
    Char_
  .

-spec pegjs_code_426_1(iolist(), index()) -> parse_result().
pegjs_code_426_1(Node, Idx) ->
...
-spec pegjs_code_444_1(iolist(), index()) -> parse_result().
pegjs_code_444_1(Node, Idx) ->
...
-spec pegjs_code_454_1(iolist(), index()) -> parse_result().
pegjs_code_454_1(Node, Idx) ->
...
-spec pegjs_code_484_1(iolist(), index()) -> parse_result().
pegjs_code_484_1(Node, _Idx) ->
...
-spec pegjs_code_490_1(iolist(), index()) -> parse_result().
pegjs_code_490_1(_Node, _Idx) ->

    "\x{00}"
  .

-spec pegjs_code_499_1(iolist(), index()) -> parse_result().
pegjs_code_499_1(Node, _Idx) ->
...
-spec pegjs_code_508_1(iolist(), index()) -> parse_result().
pegjs_code_508_1(Node, _Idx) ->
...
-spec pegjs_code_513_4(iolist(), index()) -> parse_result().
pegjs_code_513_4(Node, _Idx) ->
